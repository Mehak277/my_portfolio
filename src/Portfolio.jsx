  ...
  s.textContent = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 900px) {
      .res-nav { padding: 12px 20px !important; }
      .res-hero {
      ...
      .res-hero-buttons { justify-content: center !important; }
      .res-hero-right {
        flex: none !important;
        transform: scale(0.9) !important;
      }
      .res-section { padding: 60px 20px !important; }
      .res-contact-grid {
      ...
      .chip-a { right: -5% !important; top: -5% !important; }
      .chip-b { left: -5% !important; bottom: 5% !important; }
      .chip-c { right: -10% !important; top: 40% !important; }
    }
    ...
    @media (max-width: 600px) {
      ...
      .res-hero { padding: 180px 20px 40px !important; }
      .res-hero-right { transform: scale(0.8) !important; }
    }
  `;
  ...
  return (
    <div style={s.root}>
      ...
      <nav className="res-nav" style={{
        ...
        <div className="res-nav-links" style={s.navLinks}>
          {["home", "skills", "projects", "contact"].map((sec) => (
            <button key={sec} className="res-nav-btn"
      ...
      <section id="home" className="res-hero" style={s.hero}>
        <div className="res-hero-left" style={s.heroLeft}>
          ...
          <div className="res-hero-buttons" style={s.heroButtons}>
        ...
        <div className="res-hero-right" style={s.heroRight}>
      ...
      {/* ── SKILLS ── */}
      <section id="skills" className="res-section" style={s.section}>
      ...
      {/* ── PROJECTS ── */}
      <section id="projects" className="res-section" style={s.section}>
      ...
      {/* ── CONTACT ── */}
      <section id="contact" className="res-section" style={s.section}>
        <SectionHeader label="Get In Touch" title="Let's Work Together" />
        <div className="res-contact-grid" style={s.contactGrid}>
      ...
      <footer className="res-footer" style={s.footer}>
